...
def check_drinks(drink_name, drink_ingredients):
    ...
    is_mock = set(drink_ingredients).isdisjoint(ALCOHOLS)
    type = "Mocktail" if is_mock else "Cocktail"
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category_name, category in {"VEGAN": VEGAN, "VEGETARIAN": VEGETARIAN, "PALEO": PALEO, "KETO": KETO, "OMNIVORE": OMNIVORE}.items():
...
def singleton_ingredients(dishes, intersection):
    ...
    for ingredients in dishes:
        result.update(ingredients - intersection)
    return result
